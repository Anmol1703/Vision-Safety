...
def generate_filename():
    ...
    # C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches/
    st="C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches/"+ st+".jpg"
    # st="C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches/"+st+".jpg"
    return st
def generate_filename1():
    now = datetime.datetime.now()
    st=now.strftime("%Y-%m-%d_%H-%M-%S")
    st="C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches_without_halmet/"+st+".jpg"
    return st
...
known_faces_dir = "C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/known_faces"
...
def generate_frames3():
    ...
    model3=YOLO('C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/weights')
    while True:
        document1=collection1.find_one(filter)
        ch=document1['breach']
        success1,frame1 = cap1.read()
...
def delete():
    ...
    print(text)
    file_path = 'C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/known_faces/'
...
def data_breach():
    l=[]
    pathh="C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches"
...
def data_breach1():
    l=[]
    pathh="C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches_without_halmet"
    for i in os.listdir(pathh):
        if i.endswith(".jpg"):
            l.append(i)
            print(i)
...
def calculate_graph():
    days=[]
    times=[]
    for filename in os.listdir("C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches"):
        if filename.endswith(".jpg"):
...
def calculate_graph2():
    days=[]
    times=[]
    for filename in os.listdir("C:/Users/Dell/Downloads/VisionSafetyHub-main/VisionSafetyHub-main/static/breaches_without_halmet"):
        if filename.endswith(".jpg"):
            fname=filename[:4]+filename[5:7]+filename[8:10]
            if len(days)==0:
